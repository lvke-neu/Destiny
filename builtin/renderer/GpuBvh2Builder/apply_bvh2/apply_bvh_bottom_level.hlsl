...
RWStructuredBuffer<uint> bitonicSortIndicesBuffer : register(u1);
RWStructuredBuffer<StackNode> stack : register(u2);
RWStructuredBuffer<uint> nextLayerBuffer2 : register(u3);
...
{
    BVHNodeIntersect(nextLayerBuffer2[dispatchThreadID.x]);
}                                                                  