...
public:
	...
	static std::shared_ptr<Mesh> Create_Cone_PositionNormalTexcoord();
	static std::shared_ptr<Mesh> Create_Cylinder_PositionNormalTexcoord();
	static std::shared_ptr<Mesh> Create_Torus_PositionNormalTexcoord();
	static std::shared_ptr<Mesh> Create_Capsule_PositionNormalTexcoord();
