...
private:
    ...
    void initWindow()
    {
        ...
        {
            MessageBoxA(nullptr, "当前显卡驱动不支持 Vulkan！\n请更新显卡驱动。", "严重错误", MB_OK | MB_ICONERROR);
            throw std::runtime_error("driver does not support Vulkan");
        }

        glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);
        glfwWindowHint(GLFW_RESIZABLE, GLFW_TRUE);

        m_window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan Demo (Trae Generated)", nullptr, nullptr);
    ...
    {
        auto vertShaderCode = readFile(GetAssetPath("builtin/shaders/shader.vert.hlsl.spv"));
        auto fragShaderCode = readFile(GetAssetPath("builtin/shaders/shader.frag.hlsl.spv"));
    ...
    void createTextureImage()
    {
        ...
        auto texturePath = GetAssetPath("builtin/texture/box_diffuse.png");
    ...
    void createTextureSampler()
    {
        ...
        samplerInfo.anisotropyEnable = VK_FALSE; // 如果需要各向异性过滤，需要检查设备特性
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        ubo.proj[1][1] *= -1; // Vulkan 的 Y 轴坐标是反的
    ...
    static std::string GetExecutableDirectory()
    {
        ...
        std::string fullPath(modulePath, len);
...
int main()
{
    ...
    catch (const std::exception& e)
    {
        ...
        MessageBoxA(nullptr, e.what(), "程序崩溃", MB_OK | MB_ICONERROR);
        return EXIT_FAILURE;
    }
