...
namespace Destiny
{
	Octree::Octree(float sceneRadius, unsigned int octreeMaxDepth, unsigned int octreeMaxCapacity) :
		m_sceneRadius(sceneRadius),
		m_octreeMaxDepth(octreeMaxDepth),
		m_octreeMaxCapacity(octreeMaxCapacity)
	{
		box = { { 0.0f, 0.0f, 0.0f }, { sceneRadius, sceneRadius, sceneRadius } };
		depth = 1;
	}
