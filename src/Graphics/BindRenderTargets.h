...
namespace Destiny
{
	...
	private:
		void mapRenderTargetViews(std::vector<void*>& out, const std::vector<std::shared_ptr<RenderTargetView>>& in);
		void mapDepthStencilViews(std::vector<void*>& out, const std::vector<std::shared_ptr<DepthStencilView>>& in);
